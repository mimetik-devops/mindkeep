...
*Written 2026-08-28 against commit `8400366` on `main`. Everything here is checkable in
...
## 11. Architecture decisions and development log

The record behind the choices above, kept here since 2026-08-28 (it lived in its own
source before; the mirror holding entries 4.21–4.29 was lost, and those are
reconstructed in brief). Newest at the end of section 4. Write to this section the
way the entries read: the decision, the reasoning, what it replaced.

Running record of the product behind Mindkeep, written by claude-code from
direct work in the repository (`T3knomanzer/Oliver/Mindkeep`). Started
2026-08-22, first day of development.

Unlike the rest of `raw/`, this file is **maintained by claude-code rather than
by Ruben**, at his instruction, and is updated as the build progresses rather
than captured once. Treat it as a source reporting from outside the wiki — it
reports on a project, it does not reason over the wiki.
