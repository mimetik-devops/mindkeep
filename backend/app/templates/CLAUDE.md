...
- **This file is Mindstash's**, not yours and not the owner's. It ships with the app and
  is refreshed at the start of every run, so an edit you make here will not survive.

Local copies of this tree are read-only mirrors. If you are reading this from a synced
folder, answer from it, but send changes through Mindstash rather than editing in place.
