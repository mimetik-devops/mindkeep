...
- **A folder under `raw/` that a connection keeps** — a Notion space, a page at a URL,
  set up in the app — is a mirror of that source. Edit or delete a file in it and the
